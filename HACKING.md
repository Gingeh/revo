...
plaintext docs can be generated via `revo docs`, but the documentation we have for the website needs html. this is what `revo docs --html` is for
...
revo docs --html ./src/std/iface < "$STDOCPATH" > ./std.md
mv ./std.md $STDOCPATH
```
